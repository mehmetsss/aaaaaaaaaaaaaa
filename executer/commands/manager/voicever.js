...
class instaVer extends Command {
    ...
    constructor(client) {
        super(client, {
            name: "voicever",
            description: "Voicemuter rolü vermek için kullanılır",
            usage: "voiecever etiket/id",
            examples: ["voiecever 213617765095833600"],
            aliases: ["voiecever"],
    ...
    async run(client, message, args, data) {
        ...
        const verilecek = roller.get("cmd-vmuter").value();
