...
class instaVer extends Command {
    ...
    constructor(client) {
        super(client, {
            name: "taşıver",
            description: "Taşıma rolü vermek için kullanılır",
            usage: "taşıver etiket/id",
            examples: ["taşıver 213617765095833600"],
            aliases: ["taşıver"],
    ...
    async run(client, message, args, data) {
        ...
        const verilecek = roller.get("cmd-transport").value();
