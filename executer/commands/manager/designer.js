...
class instaVer extends Command {
    ...
    constructor(client) {
        super(client, {
            name: "designer",
            description: "Tasarımcı rolü vermek için kullanılır",
            usage: "tasarımcı etiket/id",
            examples: ["tasarımcı 213617765095833600"],
            aliases: ["tasarımcı"],
    ...
    async run(client, message, args, data) {
        ...
        const verilecek = roller.get("rub-designer").value();
