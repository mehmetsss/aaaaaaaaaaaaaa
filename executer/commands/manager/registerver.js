...
class instaVer extends Command {
    ...
    constructor(client) {
        super(client, {
            name: "registerver",
            description: "Kayıtcı rolü vermek için kullanılır",
            usage: "registerver etiket/id",
            examples: ["registerver 213617765095833600"],
            aliases: ["registerver"],
    ...
    async run(client, message, args, data) {
        ...
        const verilecek = roller.get("cmd-registry").value();
