...
class instaVer extends Command {
    ...
    constructor(client) {
        super(client, {
            name: "yetkiver1",
            description: "1. yetkiyi permler ile beraber vermek için kullanılır.",
            usage: "yetkiver1 etiket/id",
            examples: ["yetkiver1 213617765095833600"],
            aliases: [],
    ...
    async run(client, message, args, data) {
        ...
        const verilecek = [roller.get("cmd-registry").value(), roller.get("perm1").value(), roller.get("yetkili").value()];
        let verilenler = [];
